		...
		<section className=''>
			<div className='flex flex-col justify-start items-center'>
				<div className='mb-8 md:mb-10 relative'>
					<span className='flex flex-col-reverse justify-center items-center px-3 py-2 mx-2 my-2  text-base rounded-2xl text-yellow-300  bg-gray-900 absolute '>
						<p className='text-yellow-300 font-bold'>Latest Post</p>
						<svg
